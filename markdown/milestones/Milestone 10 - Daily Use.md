...
[[006]] Android pinch/rotate, [[007]] Android app name + icon; deferred parts of 012 (hover preview, embeds). Open question: whether the search stall was the embedding call (fixed) or something else Daniel sees.
