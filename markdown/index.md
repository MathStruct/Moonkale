...
> [!info] Status — Milestone 10 in progress: daily use, specs as the backlog
> **Second halves.** History you can act on (compaction into snapshots, **Restore** any earlier text as an unsaved edit with provenance); presence with **cursor lines** in the editor gutter and a **desktop hub client**; node dragging in 3D; **DuckDB** — `.duckdb` files and folders of CSV/TSV/Parquet as queryable tables. And the first **Android** build: the release APK runs on a Galaxy S10e — phone shell, editor with the soft keyboard, save + history, graph on WebGL2 (five Android-only fixes, P-087–P-091). See [[Milestone 9 - Implementation Log]] · [[Milestone 10 - Daily Use]]. Before that, Milestone 8 —
...
| Architecture | [[Overview]] · [[Platform Matrix]] · [[Data Sources]] · [[Projects and Sources]] · [[Julia and Lenticulum]] · [[Publishing Sources]] · [[Annotations]] · [[Indexing]] · [[Extension System]] · [[JS Interop Boundary]] · [[JavaScript Inventory]] · [[LLM and RAG]] · [[LSP and Terminal]] · [[Debugging and Logging]] · [[Version Management]] · [[Collaboration]] |
| Editors | [[Code Editor]] · [[Markdown and Typst Editor]] · [[Table Editor]] · [[Graph View]] · [[Flow Editor]] · [[Terminal]] · [[Unicode Input]] · [[Case Selector]] · [[Markdown Diagrams and Math]] |
